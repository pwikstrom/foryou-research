...
- **analysis.embeddings** -> analysis.embedding_backends, data_io, logging_setup
...
- **annotation.ab_eval** -> annotation.backends (L), annotation_contract, annotation_schema, data_io, fyp_config (L), machine_annotation (L), media_paths (L), recode_variables (L), types
...
- **annotation.backends.gemini** -> annotation.backends.base, core.gemini_client, fyp_config, machine_annotation (L)
- **annotation.backends.minicpm_local** -> annotation.backends (L), annotation.backends.base, annotation.backends.minicpm_sanitize_fix (L), annotation.backends.qwen_local, annotation_schema (L), annotation_versioning (L), fyp_config, logging_setup
...
- **annotation.backends.qwen_api** -> annotation.backends.base, annotation.backends.qwen_local, annotation_schema (L), annotation_versioning (L), fyp_config, logging_setup
- **annotation.backends.qwen_local** -> annotation.backends (L), annotation.backends.base, annotation.backends.qwen_rope_fix (L), annotation_schema (L), annotation_versioning (L), fyp_config, logging_setup, media_paths (L), scrape_queues (L)
...
- **fyp.analysis.embedding_backends.settings**: 1 file(s)
  - web_interface/admin_settings.py
- **fyp.analysis.embeddings**: 2 file(s)
  - tests/unit/test_embedding_qwen_api.py
  - tests/unit/test_embeddings_store_scoping.py
- **fyp.analysis.video_map**: 1 file(s)
...
- **fyp.annotation**: 6 file(s)
  ...
  - tests/unit/test_fresh_install_fixes.py
  - tests/unit/test_inference_ts_backfill.py
  - web_interface/routes/management/enrichment.py
  - web_interface/services/system_health.py
- **fyp.annotation.ab_eval**: 1 file(s)
  - scripts/adhoc/qwen_eval/03_compare.py
- **fyp.annotation.backends**: 21 file(s)
  - scripts/setup.py
  - tests/unit/test_ab_eval_backend_arms.py
...
- **fyp.annotation.backends.settings**: 2 file(s)
  - web_interface/admin_settings.py
  - web_interface/routes/management/contracts.py
- **fyp.annotation.machine_annotation**: 3 file(s)
  - tests/unit/test_gemini_client_modes.py
  - web_interface/routes/management/enrichment.py
  - web_interface/routes/process_routes.py
...
- **fyp.annotation_contract**: 16 file(s)
  ...
  - web_interface/routes/management/schema.py
  - web_interface/run_ab_eval.py
- **fyp.annotation_schema**: 15 file(s)
  - scripts/adhoc/qwen_eval/00_dump_contract.py
  - scripts/adhoc/qwen_eval/03_compare.py
  ...
  - tests/unit/test_runtime_annotation_contract.py
  - web_interface/routes/management/contracts.py
- **fyp.annotation_versioning**: 18 file(s)
...
- **fyp.core.gemini_client**: 1 file(s)
  - tests/unit/test_gemini_client_modes.py
- **fyp.data_io**: 101 file(s)
  - scripts/adhoc/backfill_created_at.py
  ...
  - scripts/adhoc/qwen_eval/01_build_eval_set.py
...
- **fyp.ingest**: 12 file(s)
  ...
  - web_interface/routes/management/ingestion.py
  - web_interface/run_ingest_refresh.py
- **fyp.ingest.base**: 1 file(s)
  - tests/unit/test_fresh_install_fixes.py
- **fyp.ingest.instagram**: 1 file(s)
  - tests/unit/test_fresh_install_fixes.py
- **fyp.ingest.tiktok**: 1 file(s)
  - tests/unit/test_fresh_install_fixes.py
...
- **fyp.irrelevant_words**: 4 file(s)
  ...
  - tests/unit/test_retokenise_hashtags.py
  - web_interface/routes/auth_routes.py
- **fyp.logging_setup**: 1 file(s)
  - web_interface/drain_lease.py
- **fyp.machine_annotation**: 29 file(s)
  - scripts/adhoc/repro_resumable_refine.py
  - tests/ab_eval/_ab_common.py
  - tests/ab_eval/batch_spike.py
  - tests/ab_eval/generated_prompt_ab.py
...
- **fyp.scrape.instagram_dl**: 1 file(s)
  - tests/unit/test_instagram_image_posts.py
- **fyp.scrape.platform_scraper**: 4 file(s)
  - tests/unit/test_instagram_image_posts.py
  - tests/unit/test_instagram_scrape_fixes.py

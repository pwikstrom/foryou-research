...
function applyExplorerActiveStudy(studyName, options = {}) {
    ...
    const methodsBtn = document.getElementById('explorer-v2-methods-btn');
    if (methodsBtn) methodsBtn.style.display = studyName ? '' : 'none';
...
// ============================================================================
// Study Methods modal — the per-study methods/provenance note
// ============================================================================

let studyMethodsNote = null;   // last note fetched (for the JSON download)

async function openStudyMethodsModal() {
    const study = explorerDataV2.activeStudy;
    if (!study) return;

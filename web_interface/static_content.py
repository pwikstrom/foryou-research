...
HOME_CONTENT = {
    ...
    'note_1': (
        "Note 1: This tool is under development. It is not a well-polished "
        "product. We are aware of several bugs that remain to be fixed and "
        "greatly appreciate if you let us know about broken things you find or suggestions "
    ...
    'note_2': (
        ...
        "misleading and perhaps disturbing. For that we apologise and ask for your understanding "
